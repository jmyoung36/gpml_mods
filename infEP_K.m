function [post nlZ dnlZ] = infEP_K(hyp, cov, lik, meanfunc, K_cell, y)
                            
% Expectation Propagation approximation to the posterior Gaussian Process,
% modified to work with precomputed kernels.
% The function takes a cell array of subkernels K_cell, mean vector m,
% likelihood function lik (see likFunction.m), a set of hyperparameters hyp 
% (of which only hyp.lik may be used currently), and targets y. It is designed to be used with
% gp_K.m. See also infFunctions.m. In the EP algorithm, the sites are 
